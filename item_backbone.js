...
export const ITEMS = {
    // Scrap
    "stone":          { name: "Stone",          type: "scrap", subtype: "stone",   gather: ["mine", "forage", "chop", "scrap"], rarity: "common", value: 5 },
    "plastic":        { name: "Plastic",        type: "scrap", subtype: "plastic", gather: ["forage", "scrap"], rarity: "common", value: 5 },
    "ripped_fabric":  { name: "Ripped Fabric",  type: "scrap", subtype: "fabric",  gather: ["forage", "scrap"], rarity: "common", value: 5 },
    "wood_plank":     { name: "Wood Plank",     type: "scrap", subtype: "wood",    gather: ["chop", "forage", "scrap"], rarity: "common", value: 5 },
    "scrap_metal":    { name: "Scrap Metal",    type: "scrap", subtype: "metal",   gather: ["mine", "forage", "scrap"], rarity: "common", value: 5 },
    "bottle":         { name: "Bottle",         type: "scrap", subtype: "glass",   gather: ["forage", "scrap"], rarity: "common", value: 5 },
    "lockpick_parts": { name: "Lockpick Parts", type: "scrap", subtype: "metal",   gather: ["forage", "scrap"], rarity: "uncommon", value: 25 },
    "broken_watch":   { name: "Broken Watch",   type: "scrap", subtype: "metal",   gather: ["forage", "scrap"], rarity: "uncommon", value: 25 },
    "copper_wire":    { name: "Copper Wire",    type: "scrap", subtype: "metal",   gather: ["forage", "scrap"], rarity: "uncommon", value: 25 },
    "copper_pipe":    { name: "Copper Pipe",    type: "scrap", subtype: "metal",   gather: ["forage", "scrap"], rarity: "uncommon", value: 25 },

    // Weapons
    // - Swords
    "wooden_sword":     { name: "Wooden Sword",     type: "weapon", subtype: "sword", rarity: "common", value: 7,      damage: 5, durability: 50 },
    "tin_sword":        { name: "Tin Sword",        type: "weapon", subtype: "sword", rarity: "common", value: 10,     damage: 7, durability: 60 },
    ...
    "copper_sword":     { name: "Copper Sword",     type: "weapon", subtype: "sword", rarity: "uncommon", value: 40,   damage: 9, durability: 65 },
    "bronze_sword":     { name: "Bronze Sword",     type: "weapon", subtype: "sword", rarity: "uncommon", value: 50,   damage: 12, durability: 80 },
    "iron_sword":       { name: "Iron Sword",       type: "weapon", subtype: "sword", rarity: "common", value: 14,     damage: 10, durability: 100 },
    "cobalt_sword":     { name: "Cobalt Sword",     type: "weapon", subtype: "sword", rarity: "rare", value: 150,      damage: 15, durability: 120 },
    "steel_sword":      { name: "Steel Sword",      type: "weapon", subtype: "sword", rarity: "uncommon", value: 80,   damage: 20, durability: 150 },
    "mithril_sword":    { name: "Mithril Sword",    type: "weapon", subtype: "sword", rarity: "epic", value: 250,      damage: 35, durability: 200 },
    "adamantite_sword": { name: "Adamantite Sword", type: "weapon", subtype: "sword", rarity: "legendary", value: 350, damage: 50, durability: 300 },
    "syllic_sword":     { name: "Syllic Sword",     type: "weapon", subtype: "sword", rarity: "mythic", value: 610,    damage: 70, durability: 400 },
    // - Daggers
    "wooden_dagger":     { name: "Wooden Dagger",     type: "weapon", subtype: "dagger", rarity: "common", value: 5,      damage: 3, durability: 40 },
    "tin_dagger":        { name: "Tin Dagger",        type: "weapon", subtype: "dagger", rarity: "common", value: 7,      damage: 5, durability: 50 },
    "copper_dagger":     { name: "Copper Dagger",     type: "weapon", subtype: "dagger", rarity: "uncommon", value: 25,   damage: 6, durability: 55 },
    "bronze_dagger":     { name: "Bronze Dagger",     type: "weapon", subtype: "dagger", rarity: "uncommon", value: 35,   damage: 8, durability: 70 },
    "iron_dagger":       { name: "Iron Dagger",       type: "weapon", subtype: "dagger", rarity: "common", value: 9,      damage: 6, durability: 80 },
    "cobalt_dagger":     { name: "Cobalt Dagger",     type: "weapon", subtype: "dagger", rarity: "rare", value: 100,      damage: 10, durability: 100 },
    "steel_dagger":      { name: "Steel Dagger",      type: "weapon", subtype: "dagger", rarity: "uncommon", value: 50,   damage: 12, durability: 100 },
    "mithril_dagger":    { name: "Mithril Dagger",    type: "weapon", subtype: "dagger", rarity: "epic", value: 180,      damage: 20, durability: 150 },
    "adamantite_dagger": { name: "Adamantite Dagger", type: "weapon", subtype: "dagger", rarity: "legendary", value: 250, damage: 30, durability: 200 },
    "syllic_dagger":     { name: "Syllic Dagger",     type: "weapon", subtype: "dagger", rarity: "mythic", value: 450,    damage: 40, durability: 250 },
    // - Battleaxes
    "wooden_battleaxe":     { name: "Wooden Battleaxe",     type: "weapon", subtype: "battleaxe", rarity: "common", value: 11,     damage: 8, durability: 60 },
    "tin_battleaxe":        { name: "Tin Battleaxe",        type: "weapon", subtype: "battleaxe", rarity: "common", value: 14,     damage: 10, durability: 70 },
    "copper_battleaxe":     { name: "Copper Battleaxe",     type: "weapon", subtype: "battleaxe", rarity: "uncommon", value: 60,   damage: 15, durability: 90 },
    "bronze_battleaxe":     { name: "Bronze Battleaxe",     type: "weapon", subtype: "battleaxe", rarity: "uncommon", value: 80,   damage: 20, durability: 100 },
    "iron_battleaxe":       { name: "Iron Battleaxe",       type: "weapon", subtype: "battleaxe", rarity: "common", value: 23,     damage: 18, durability: 120 },
    "cobalt_battleaxe":     { name: "Cobalt Battleaxe",     type: "weapon", subtype: "battleaxe", rarity: "rare", value: 240,      damage: 25, durability: 150 },
    "steel_battleaxe":      { name: "Steel Battleaxe",      type: "weapon", subtype: "battleaxe", rarity: "uncommon", value: 110,  damage: 30, durability: 180 },
    "mithril_battleaxe":    { name: "Mithril Battleaxe",    type: "weapon", subtype: "battleaxe", rarity: "epic", value: 280,      damage: 40, durability: 200 },
    "adamantite_battleaxe": { name: "Adamantite Battleaxe", type: "weapon", subtype: "battleaxe", rarity: "legendary", value: 350, damage: 50, durability: 250 },
    "syllic_battleaxe":     { name: "Syllic Battleaxe",     type: "weapon", subtype: "battleaxe", rarity: "mythic", value: 530,    damage: 60, durability: 300 },
    // - Bows
    "wooden_bow":     { name: "Wooden Bow",     type: "weapon", subtype: "ranged", rarity: "common", value: 7,      damage: 5, durability: 50 },
    "tin_bow":        { name: "Tin Bow",        type: "weapon", subtype: "ranged", rarity: "common", value: 10,     damage: 7, durability: 60 },
    "copper_bow":     { name: "Copper Bow",     type: "weapon", subtype: "ranged", rarity: "uncommon", value: 40,   damage: 10, durability: 70 },
    "bronze_bow":     { name: "Bronze Bow",     type: "weapon", subtype: "ranged", rarity: "uncommon", value: 50,   damage: 12, durability: 80 },
    "iron_bow":       { name: "Iron Bow",       type: "weapon", subtype: "ranged", rarity: "common", value: 14,     damage: 10, durability: 100 },
    "cobalt_bow":     { name: "Cobalt Bow",     type: "weapon", subtype: "ranged", rarity: "rare", value: 150,      damage: 15, durability: 120 },
    "steel_bow":      { name: "Steel Bow",      type: "weapon", subtype: "ranged", rarity: "uncommon", value: 80,   damage: 20, durability: 150 },
    "mithril_bow":    { name: "Mithril Bow",    type: "weapon", subtype: "ranged", rarity: "epic", value: 250,      damage: 35, durability: 200 },
    "adamantite_bow": { name: "Adamantite Bow", type: "weapon", subtype: "ranged", rarity: "legendary", value: 350, damage: 50, durability: 300 },
    "syllic_bow":     { name: "Syllic Bow",     type: "weapon", subtype: "ranged", rarity: "mythic", value: 610,    damage: 70, durability: 400 },
    // - Slingshots
    "wooden_slingshot":     { name: "Wooden Slingshot",     type: "weapon", subtype: "slingshot", rarity: "common", value: 7,      damage: 5, durability: 50 },
    "tin_slingshot":        { name: "Tin Slingshot",        type: "weapon", subtype: "slingshot", rarity: "common", value: 10,     damage: 7, durability: 60 },
    "copper_slingshot":     { name: "Copper Slingshot",     type: "weapon", subtype: "slingshot", rarity: "uncommon", value: 40,   damage: 10, durability: 70 },
    "bronze_slingshot":     { name: "Bronze Slingshot",     type: "weapon", subtype: "slingshot", rarity: "uncommon", value: 50,   damage: 12, durability: 80 },
    "iron_slingshot":       { name: "Iron Slingshot",       type: "weapon", subtype: "slingshot", rarity: "common", value: 14,     damage: 10, durability: 100 },
    "cobalt_slingshot":     { name: "Cobalt Slingshot",     type: "weapon", subtype: "slingshot", rarity: "rare", value: 150,      damage: 15, durability: 120 },
    "steel_slingshot":      { name: "Steel Slingshot",      type: "weapon", subtype: "slingshot", rarity: "uncommon", value: 80,   damage: 20, durability: 150 },
    "mithril_slingshot":    { name: "Mithril Slingshot",    type: "weapon", subtype: "slingshot", rarity: "epic", value: 250,      damage: 35, durability: 200 },
    "adamantite_slingshot": { name: "Adamantite Slingshot", type: "weapon", subtype: "slingshot", rarity: "legendary", value: 350, damage: 50, durability: 300 },
    "syllic_slingshot":     { name: "Syllic Slingshot",     type: "weapon", subtype: "slingshot", rarity: "mythic", value: 610,    damage: 70, durability: 400 },
    // - Magic Staves
    "wooden_staff":     { name: "Wooden Staff",     type: "weapon", subtype: "staff", rarity: "common", value: 7,      damage: 5, durability: 50 },
    "tin_staff":        { name: "Tin Staff",        type: "weapon", subtype: "staff", rarity: "common", value: 10,     damage: 7, durability: 60 },
    "copper_staff":     { name: "Copper Staff",     type: "weapon", subtype: "staff", rarity: "uncommon", value: 40,   damage: 10, durability: 70 },
    "bronze_staff":     { name: "Bronze Staff",     type: "weapon", subtype: "staff", rarity: "uncommon", value: 50,   damage: 12, durability: 80 },
    "iron_staff":       { name: "Iron Staff",       type: "weapon", subtype: "staff", rarity: "common", value: 14,     damage: 10, durability: 100 },
    "cobalt_staff":     { name: "Cobalt Staff",     type: "weapon", subtype: "staff", rarity: "rare", value: 150,      damage: 15, durability: 120 },
    "steel_staff":      { name: "Steel Staff",      type: "weapon", subtype: "staff", rarity: "uncommon", value: 80,   damage: 20, durability: 150 },
    "mithril_staff":    { name: "Mithril Staff",    type: "weapon", subtype: "staff", rarity: "epic", value: 250,      damage: 35, durability: 200 },
    "adamantite_staff": { name: "Adamantite Staff", type: "weapon", subtype: "staff", rarity: "legendary", value: 350, damage: 50, durability: 300 },
    "syllic_staff":     { name: "Syllic Staff",     type: "weapon", subtype: "staff", rarity: "mythic", value: 610,    damage: 70, durability: 400 },

    // Combat Tools and Resources
    // - Aid
    "bandage_box": { name: "Bandage Box", type: "tool", subtype: "combat_aid", rarity: "common", value: 10, effect: "heals minor wounds", durability: 5 },
    "medic_bag": { name: "Medic Bag", type: "tool", subtype: "combat_aid", rarity: "uncommon", value: 50, effect: "heals moderate wounds", durability: 10 },
    "trauma_bag": { name: "Trauma Bag", type: "tool", subtype: "combat_aid", rarity: "rare", value: 150, effect: "heals severe wounds", durability: 15 },
    "aegis_kit": { name: "AEGIS Kit", type: "tool", subtype: "combat_aid", rarity: "epic", value: 250, effect: "heals critical wounds and stabilizes the patient", durability: 20 },
    "phoenix_kit": { name: "Phoenix Kit", type: "tool", subtype: "combat_aid", rarity: "legendary", value: 350, effect: "heals critical wounds, stabilizes the patient, and revives them from death", durability: 25 },
    // - Bait
    "small_bait": { name: "Small Bait", type: "tool", subtype: "combat_bait", rarity: "common", value: 10, effect: "attracts small enemies", durability: 10 },
    "medium_bait": { name: "Medium Bait", type: "tool", subtype: "combat_bait", rarity: "uncommon", value: 50, effect: "attracts medium enemies", durability: 20 },
    "large_bait": { name: "Large Bait", type: "tool", subtype: "combat_bait", rarity: "rare", value: 150, effect: "attracts large enemies", durability: 30 },
    "small_group_bait": { name: "Small Group Bait", type: "tool", subtype: "combat_bait", rarity: "uncommon", value: 50, effect: "attracts a small group of enemies", durability: 15 },
    "medium_group_bait": { name: "Medium Group Bait", type: "tool", subtype: "combat_bait", rarity: "rare", value: 150, effect: "attracts a medium group of enemies", durability: 25 },
    "large_group_bait": { name: "Large Group Bait", type: "tool", subtype: "combat_bait", rarity: "epic", value: 250, effect: "attracts a large group of enemies", durability: 35 },
    // - Traps
    "trap": { name: "Trap", type: "tool", subtype: "combat_trap", rarity: "common", value: 10, effect: "traps enemies for a short time", durability: 5 },
    "large_trap": { name: "Large Trap", type: "tool", subtype: "combat_trap", rarity: "uncommon", value: 50, effect: "traps enemies for a moderate time", durability: 8 },
    "net_trap": { name: "Net Trap", type: "tool", subtype: "combat_trap", rarity: "uncommon", value: 50, effect: "traps enemies for a longer time", durability: 10 },
    "large_net_trap": { name: "Large Net Trap", type: "tool", subtype: "combat_trap", rarity: "rare", value: 150, effect: "traps enemies for a long time", durability: 15 },
    "escape_trap": { name: "Escape Trap", type: "tool", subtype: "combat_trap", rarity: "epic", value: 250, effect: "traps enemies for a very long time and allows the user to escape", durability: 20 },
    // - Bombs
    "bomb": { name: "Bomb", type: "tool", subtype: "combat_bomb", rarity: "uncommon", value: 50, effect: "deals area damage to enemies", durability: 1 },
    "smoke_bomb": { name: "Smoke Bomb", type: "tool", subtype: "combat_bomb", rarity: "rare", value: 150, effect: "creates a smoke screen to escape enemies", durability: 1 },
    "flash_bomb": { name: "Flash Bomb", type: "tool", subtype: "combat_bomb", rarity: "epic", value: 250, effect: "blinds enemies for a short time", durability: 1 },
    "sticky_bomb": { name: "Sticky Bomb", type: "tool", subtype: "combat_bomb", rarity: "legendary", value: 350, effect: "sticks to enemies and deals damage over time", durability: 1 },
    "nuclear_bomb": { name: "Nuclear Bomb", type: "tool", subtype: "combat_bomb", rarity: "mythic", value: 650, effect: "deals massive area damage to enemies, killing them.", durability: 1 },

    
    // Armors
    "simple_hood":          { name: "Simple Hood",          type: "armor", slot: "head", subtype: "simple_robe", rarity: "common", value: 4, defense: 2, durability: 30 },
    "simple_gloves":        { name: "Simple Gloves",        type: "armor", slot: "hands", subtype: "simple_robe", rarity: "common", value: 4, defense: 2, durability: 30 },
    "simple_tunic":         { name: "Simple Tunic",         type: "armor", slot: "torso", subtype: "simple_robe", rarity: "common", value: 4, defense: 4, durability: 50 },
    "simple_pants":         { name: "Simple Pants",         type: "armor", slot: "legs", subtype: "simple_robe", rarity: "common", value: 4, defense: 3, durability: 40 },
    "simple_boots":         { name: "Simple Boots",         type: "armor", slot: "boots", subtype: "simple_robe", rarity: "common", value: 4, defense: 2, durability: 30 },
    "simple_cloak":         { name: "Simple Cloak",         type: "armor", slot: "cloak", subtype: "simple_robe", rarity: "common", value: 4, defense: 1, durability: 20 },

    "leather_cowl":       { name: "Leather Cowl",       type: "armor", slot: "head", subtype: "leather", rarity: "common", value: 5, defense: 5, durability: 50 },
    "leather_gloves":     { name: "Leather Gloves",     type: "armor", slot: "hands", subtype: "leather", rarity: "common", value: 5, defense: 5, durability: 50 },
    "leather_tunic":      { name: "Leather Tunic",      type: "armor", slot: "torso", subtype: "leather", rarity: "common", value: 10, defense: 10, durability: 80 },
    "leather_pants":      { name: "Leather Pants",      type: "armor", slot: "legs", subtype: "leather", rarity: "common", value: 8, defense: 8, durability: 70 },
    "leather_boots":      { name: "Leather Boots",      type: "armor", slot: "boots", subtype: "leather", rarity: "common", value: 5, defense: 5, durability: 50 },

    "tin_helmet":        { name: "Tin Helmet",        type: "armor", slot: "head", subtype: "tin", rarity: "common", value: 10, defense: 10, durability: 100 },
    "tin_gauntlets":     { name: "Tin Gauntlets",     type: "armor", slot: "hands", subtype: "tin", rarity: "common", value: 10, defense: 10, durability: 100 },
    "tin_chestplate":    { name: "Tin Chestplate",    type: "armor", slot: "torso", subtype: "tin", rarity: "common", value: 19, defense: 20, durability: 150 },
    "tin_leggings":      { name: "Tin Leggings",      type: "armor", slot: "legs", subtype: "tin", rarity: "common", value: 14, defense: 15, durability: 120 },
    "tin_boots":         { name: "Tin Boots",         type: "armor", slot: "boots", subtype: "tin", rarity: "common", value: 10, defense: 10, durability: 100 },

    "copper_helmet":     { name: "Copper Helmet",     type: "armor", slot: "head", subtype: "copper", rarity: "uncommon", value: 35, defense: 12, durability: 110 },
    "copper_gauntlets":  { name: "Copper Gauntlets",  type: "armor", slot: "hands", subtype: "copper", rarity: "uncommon", value: 35, defense: 12, durability: 110 },
    "copper_chestplate": { name: "Copper Chestplate", type: "armor", slot: "torso", subtype: "copper", rarity: "uncommon", value: 55, defense: 22, durability: 160 },
    "copper_leggings":   { name: "Copper Leggings",   type: "armor", slot: "legs", subtype: "copper", rarity: "uncommon", value: 50, defense: 18, durability: 130 },
    "copper_boots":      { name: "Copper Boots",      type: "armor", slot: "boots", subtype: "copper", rarity: "uncommon", value: 35, defense: 12, durability: 110 },

    "chainmail_cowl":       { name: "Chainmail Cowl",       type: "armor", slot: "head", subtype: "chainmail", rarity: "rare", value: 100, defense: 20, durability: 150 },
    "chainmail_gloves":     { name: "Chainmail Gloves",     type: "armor", slot: "hands", subtype: "chainmail", rarity: "rare", value: 100, defense: 20, durability: 150 },
    "chainmail_tunic":      { name: "Chainmail Tunic",      type: "armor", slot: "torso", subtype: "chainmail", rarity: "rare", value: 190, defense: 40, durability: 250 },
    "chainmail_pants":      { name: "Chainmail Pants",      type: "armor", slot: "legs", subtype: "chainmail", rarity: "rare", value: 150, defense: 30, durability: 200 },
    "chainmail_boots":      { name: "Chainmail Boots",      type: "armor", slot: "boots", subtype: "chainmail", rarity: "rare", value: 100, defense: 20, durability: 150 },

    "bronze_helmet":     { name: "Bronze Helmet",     type: "armor", slot: "head", subtype: "bronze", rarity: "uncommon", value: 40, defense: 15, durability: 120 },
    "bronze_gauntlets":  { name: "Bronze Gauntlets",  type: "armor", slot: "hands", subtype: "bronze", rarity: "uncommon", value: 40, defense: 15, durability: 120 },
    "bronze_chestplate": { name: "Bronze Chestplate", type: "armor", slot: "torso", subtype: "bronze", rarity: "uncommon", value: 65, defense: 25, durability: 180 },
    "bronze_leggings":   { name: "Bronze Leggings",   type: "armor", slot: "legs", subtype: "bronze", rarity: "uncommon", value: 50, defense: 20, durability: 150 },
    "bronze_boots":      { name: "Bronze Boots",      type: "armor", slot: "boots", subtype: "bronze", rarity: "uncommon", value: 40, defense: 15, durability: 120 },

    "iron_helmet":       { name: "Iron Helmet",     type: "armor", slot: "head", subtype: "iron", rarity: "common", value: 10, defense: 10, durability: 100 },
    "iron_gauntlets":    { name: "Iron Gauntlets",  type: "armor", slot: "hands", subtype: "iron", rarity: "common", value: 10, defense: 10, durability: 100 },
    "iron_chestplate":   { name: "Iron Chestplate", type: "armor", slot: "torso", subtype: "iron", rarity: "common", value: 19, defense: 20, durability: 150 },
    "iron_leggings":     { name: "Iron Leggings",   type: "armor", slot: "legs", subtype: "iron", rarity: "common", value: 14, defense: 15, durability: 120 },
    "iron_boots":        { name: "Iron Boots",      type: "armor", slot: "boots", subtype: "iron", rarity: "common", value: 10, defense: 10, durability: 100 },

    "cobalt_helmet":     { name: "Cobalt Helmet",     type: "armor", slot: "head", subtype: "cobalt", rarity: "rare", value: 150, defense: 30, durability: 150 },
    "cobalt_gauntlets":  { name: "Cobalt Gauntlets",  type: "armor", slot: "hands", subtype: "cobalt", rarity: "rare", value: 150, defense: 30, durability: 150 },
    "cobalt_chestplate": { name: "Cobalt Chestplate", type: "armor", slot: "torso", subtype: "cobalt", rarity: "rare", value: 190, defense: 40, durability: 200 },
    "cobalt_leggings":   { name: "Cobalt Leggings",   type: "armor", slot: "legs", subtype: "cobalt", rarity: "rare", value: 170, defense: 35, durability: 180 },
    "cobalt_boots":      { name: "Cobalt Boots",      type: "armor", slot: "boots", subtype: "cobalt", rarity: "rare", value: 150, defense: 30, durability: 150 },

    "steel_helmet":      { name: "Steel Helmet",     type: "armor", slot: "head", subtype: "steel", rarity: "uncommon", value: 50, defense: 20, durability: 150 },
    "steel_gauntlets":   { name: "Steel Gauntlets",  type: "armor", slot: "hands", subtype: "steel", rarity: "uncommon", value: 50, defense: 20, durability: 150 },
    "steel_chestplate":  { name: "Steel Chestplate", type: "armor", slot: "torso", subtype: "steel", rarity: "uncommon", value: 75, defense: 30, durability: 200 },
    "steel_leggings":    { name: "Steel Leggings",   type: "armor", slot: "legs", subtype: "steel", rarity: "uncommon", value: 65, defense: 25, durability: 180 },
    "steel_boots":       { name: "Steel Boots",      type: "armor", slot: "boots", subtype: "steel", rarity: "uncommon", value: 50, defense: 20, durability: 150 },

    "mithril_helmet":     { name: "Mithril Helmet", type: "armor", slot: "head", subtype: "mithril", rarity: "epic", value: 250, defense: 40, durability: 200 },
    "mithril_gauntlets":  { name: "Mithril Gauntlets", type: "armor", slot: "hands", subtype: "mithril", rarity: "epic", value: 250, defense: 40, durability: 200 },
    "mithril_chestplate": { name: "Mithril Chestplate", type: "armor", slot: "torso", subtype: "mithril", rarity: "epic", value: 310, defense: 50, durability: 250 },
    "mithril_leggings":   { name: "Mithril Leggings", type: "armor", slot: "legs", subtype: "mithril", rarity: "epic", value: 280, defense: 45, durability: 220 },
    "mithril_boots":      { name: "Mithril Boots", type: "armor", slot: "boots", subtype: "mithril", rarity: "epic", value: 250, defense: 40, durability: 200 },

    "adamantite_helmet":     { name: "Adamantite Helmet", type: "armor", slot: "head", subtype: "adamantite", rarity: "legendary", value: 350, defense: 60, durability: 250 },
    "adamantite_gauntlets":  { name: "Adamantite Gauntlets", type: "armor", slot: "hands", subtype: "adamantite", rarity: "legendary", value: 350, defense: 60, durability: 250 },
    "adamantite_chestplate": { name: "Adamantite Chestplate", type: "armor", slot: "torso", subtype: "adamantite", rarity: "legendary", value: 400, defense: 70, durability: 300 },
    "adamantite_leggings":   { name: "Adamantite Leggings", type: "armor", slot: "legs", subtype: "adamantite", rarity: "legendary", value: 380, defense: 65, durability: 280 },
    "adamantite_boots":      { name: "Adamantite Boots", type: "armor", slot: "boots", subtype: "adamantite", rarity: "legendary", value: 350, defense: 60, durability: 250 },

    "syllic_helmet":     { name: "Syllic Helmet", type: "armor", slot: "head", subtype: "syllic", rarity: "mythic", value: 1950, defense: 80, durability: 300 },
    "syllic_gauntlets":  { name: "Syllic Gauntlets", type: "armor", slot: "hands", subtype: "syllic", rarity: "mythic", value: 1950, defense: 80, durability: 300 },
    "syllic_chestplate": { name: "Syllic Chestplate", type: "armor", slot: "torso", subtype: "syllic", rarity: "mythic", value: 1950, defense: 90, durability: 350 },
    "syllic_leggings":   { name: "Syllic Leggings", type: "armor", slot: "legs", subtype: "syllic", rarity: "mythic", value: 1950, defense: 85, durability: 320 },
    "syllic_boots":      { name: "Syllic Boots", type: "armor", slot: "boots", subtype: "syllic", rarity: "mythic", value: 1950, defense: 80, durability: 300 },

    // Mage Robes
    "blue_mage_hood":       { name: "Blue Mage Hood",       type: "armor", slot: "head", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "blue_mage_gloves":     { name: "Blue Mage Gloves",     type: "armor", slot: "hands", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "blue_mage_robe":       { name: "Blue Mage Robe",       type: "armor", slot: "torso", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 650, defense: 20, durability: 150 },
    "blue_mage_pants":      { name: "Blue Mage Pants",      type: "armor", slot: "legs", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 500, defense: 15, durability: 120 },
    "blue_mage_boots":      { name: "Blue Mage Boots",      type: "armor", slot: "boots", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "blue_mage_cape":       { name: "Blue Mage Cape",       type: "armor", slot: "cloak", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 5, durability: 80 },

    "red_mage_hood":       { name: "Red Mage Hood",       type: "armor", slot: "head", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "red_mage_gloves":     { name: "Red Mage Gloves",     type: "armor", slot: "hands", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "red_mage_robe":       { name: "Red Mage Robe",       type: "armor", slot: "torso", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 650, defense: 20, durability: 150 },
    "red_mage_pants":      { name: "Red Mage Pants",      type: "armor", slot: "legs", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 500, defense: 15, durability: 120 },
    "red_mage_boots":      { name: "Red Mage Boots",      type: "armor", slot: "boots", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "red_mage_cape":       { name: "Red Mage Cape",       type: "armor", slot: "cloak", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 5, durability: 80 },

    "green_mage_hood":       { name: "Green Mage Hood",       type: "armor", slot: "head", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "green_mage_gloves":     { name: "Green Mage Gloves",     type: "armor", slot: "hands", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "green_mage_robe":       { name: "Green Mage Robe",       type: "armor", slot: "torso", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 650, defense: 20, durability: 150 },
    "green_mage_pants":      { name: "Green Mage Pants",      type: "armor", slot: "legs", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 500, defense: 15, durability: 120 },
    "green_mage_boots":      { name: "Green Mage Boots",      type: "armor", slot: "boots", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 10, durability: 100 },
    "green_mage_cape":       { name: "Green Mage Cape",       type: "armor", slot: "cloak", subtype: "mage_robe", robetype: "basic", rarity: "mythic", value: 450, defense: 5, durability: 80 },

    // Advanced Mage Robes (Mage Armors)
    "black_mage_hood":       { name: "Black Mage Hood",       type: "armor", slot: "head", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 650, defense: 20, durability: 140 },
    "black_mage_gloves":     { name: "Black Mage Gloves",     type: "armor", slot: "hands", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 650, defense: 20, durability: 140 },
    "black_mage_robe":       { name: "Black Mage Robe",       type: "armor", slot: "torso", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 1200, defense: 40, durability: 200 },
    "black_mage_pants":      { name: "Black Mage Pants",      type: "armor", slot: "legs", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 940, defense: 30, durability: 180 },
    "black_mage_boots":      { name: "Black Mage Boots",      type: "armor", slot: "boots", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 650, defense: 20, durability: 140 },
    "black_mage_cape":       { name: "Black Mage Cape",       type: "armor", slot: "cloak", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 450, defense: 10, durability: 120 },

    "white_mage_hood":       { name: "White Mage Hood",       type: "armor", slot: "head", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 650, defense: 20, durability: 140 },
    "white_mage_gloves":     { name: "White Mage Gloves",     type: "armor", slot: "hands", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 650, defense: 20, durability: 140 },
    "white_mage_robe":       { name: "White Mage Robe",       type: "armor", slot: "torso", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 1200, defense: 40, durability: 200 },
    "white_mage_pants":      { name: "White Mage Pants",      type: "armor", slot: "legs", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 940, defense: 30, durability: 180 },
    "white_mage_boots":      { name: "White Mage Boots",      type: "armor", slot: "boots", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 650, defense: 20, durability: 140 },
    "white_mage_cape":       { name: "White Mage Cape",       type: "armor", slot: "cloak", subtype: "mage_robe", robetype: "advanced", rarity: "mythic", value: 450, defense: 10, durability: 120 },

    // Shields
    "wooden_shield":     { name: "Wooden Shield",     type: "armor", slot: "shield", subtype: "wooden", rarity: "common", value: 10, defense: 10, durability: 100 },
    "tin_shield":        { name: "Tin Shield",        type: "armor", slot: "shield", subtype: "tin", rarity: "common", value: 14, defense: 15, durability: 120 },
    "copper_shield":     { name: "Copper Shield",     type: "armor", slot: "shield", subtype: "copper", rarity: "uncommon", value: 50, defense: 18, durability: 140 },
    "chainmail_shield":  { name: "Chainmail Shield",  type: "armor", slot: "shield", subtype: "chainmail", rarity: "rare", value: 130, defense: 25, durability: 180 },
    "bronze_shield":     { name: "Bronze Shield",     type: "armor", slot: "shield", subtype: "bronze", rarity: "uncommon", value: 50, defense: 20, durability: 150 },
    "iron_shield":       { name: "Iron Shield",       type: "armor", slot: "shield", subtype: "iron", rarity: "common", value: 14, defense: 15, durability: 120 },
    "cobalt_shield":     { name: "Cobalt Shield",     type: "armor", slot: "shield", subtype: "cobalt", rarity: "rare", value: 150, defense: 30, durability: 200 },
    "steel_shield":      { name: "Steel Shield",      type: "armor", slot: "shield", subtype: "steel", rarity: "uncommon", value: 65, defense: 25, durability: 180 },
    "mithril_shield":    { name: "Mithril Shield",    type: "armor", slot: "shield", subtype: "mithril", rarity: "epic", value: 250, defense: 40, durability: 250 },
    "adamantite_shield": { name: "Adamantite Shield", type: "armor", slot: "shield", subtype: "adamantite", rarity: "legendary", value: 300, defense: 50, durability: 300 },
    "syllic_shield":     { name: "Syllic Shield",     type: "armor", slot: "shield", subtype: "syllic", rarity: "mythic", value: 1750, defense: 60, durability: 350 },

    // Potions
    "healing_potion": { name: "Healing Potion", type: "potion", subtype: "heal", rarity: "common", value: 10, heal: 20 },
    "mana_potion": { name: "Mana Potion", type: "potion", subtype: "mana", rarity: "common", value: 10, mana_restore: 20 },
    "attack_potion": { name: "Attack Potion", type: "potion", subtype: "buff", rarity: "uncommon", value: 50, buff: { stat: "attack", duration: 30 } },
    "strength_potion": { name: "Strength Potion", type: "potion", subtype: "buff", rarity: "uncommon", value: 50, buff: { stat: "strength", duration: 30 } },
    "defense_potion": { name: "Defense Potion", type: "potion", subtype: "buff", rarity: "uncommon", value: 50, buff: { stat: "defense", duration: 30 } },
    
    // Poisons
    "poison_potion": { name: "Poison Potion", type: "potion", subtype: "poison", rarity: "rare", value: 100, poison_damage: 20 },
    "defense_debuff_poison": { name: "Defense Debuff Poison", type: "potion", subtype: "poison", rarity: "uncommon", value: 50, poison: { stat: "defense", duration: 30 } },
    "health_poison": { name: "Health Poison", type: "potion", subtype: "poison", rarity: "uncommon", value: 60, poison: { stat: "health", damage: 25 } },
    
    // Aid Items
    "bandage": { name: "Bandage", type: "aid", subtype: "heal", rarity: "common", value: 10, heal: 10 },
    "antidote": { name: "Antidote", type: "aid", subtype: "cure", rarity: "common", value: 10, cure: ["poison"] },
    "elixir": { name: "Elixir", type: "aid", subtype: "restore", rarity: "rare", value: 150, restore: ["health", "mana"] },
    "revive": { name: "Revive", type: "aid", subtype: "revive", rarity: "rare", value: 150, revive: true },
    "antivenom": { name: "Antivenom", type: "aid", subtype: "cure", rarity: "uncommon", value: 50, cure: ["poison"] },

    // Tools
    // - Tool Starters
    "shovel_starter": { name: "Shovel Starter", type: "crafting", subtype: "tool", rarity: "common", value: 10, durability: 50 },
    "saw_starter": { name: "Saw Starter", type: "crafting", subtype: "tool", rarity: "common", value: 10, durability: 50 },
    "axe_starter": { name: "Axe Starter", type: "crafting", subtype: "tool", rarity: "common", value: 10, durability: 50 },
    "fishing_rod_starter": { name: "Fishing Rod Starter", type: "crafting", subtype: "tool", rarity: "common", value: 10, durability: 50 },
    "pickaxe_starter": { name: "Pickaxe Starter", type: "crafting", subtype: "tool", rarity: "common", value: 10, durability: 50 },
    // - Basic Tools
    "hammer": { name: "Hammer", type: "tool", subtype: "hammer", rarity: "common", value: 7, durability: 50 },
    "shovel": { name: "Shovel", type: "tool", subtype: "shovel", rarity: "common", value: 9, durability: 60 },
    "saw":    { name: "Saw",    type: "tool", subtype: "saw",    rarity: "common", value: 10, durability: 70 },
    "axe":    { name: "Axe",    type: "tool", subtype: "axe",    rarity: "common", value: 11, durability: 80 },
    ...
    "pickaxe": { name: "Pickaxe", type: "tool", subtype: "pickaxe", rarity: "common", value: 9, durability: 60 },
    "lockpick": { name: "Lockpick", type: "tool", subtype: "lockpick", rarity: "uncommon", value: 35, durability: 50 },
    // - Advanced Tools
    // - - Shovels
    "tin_shovel": { name: "Tin Shovel", type: "tool", subtype: "shovel", rarity: "common", value: 10, durability: 70 },
    "copper_shovel": { name: "Copper Shovel", type: "tool", subtype: "shovel", rarity: "common", value: 10, durability: 70 },
    "bronze_shovel": { name: "Bronze Shovel", type: "tool", subtype: "shovel", rarity: "uncommon", value: 50, durability: 80 },
    "iron_shovel": { name: "Iron Shovel", type: "tool", subtype: "shovel", rarity: "common", value: 10, durability: 70 },
    "steel_shovel": { name: "Steel Shovel", type: "tool", subtype: "shovel", rarity: "uncommon", value: 50, durability: 80 },
    "mithril_shovel": { name: "Mithril Shovel", type: "tool", subtype: "shovel", rarity: "epic", value: 250, durability: 150 },
    "adamantite_shovel": { name: "Adamantite Shovel", type: "tool", subtype: "shovel", rarity: "legendary", value: 350, durability: 200 },
    "syllic_shovel": { name: "Syllic Shovel", type: "tool", subtype: "shovel", rarity: "mythic", value: 650, durability: 250 },
    // - - Saws
    "tin_saw": { name: "Tin Saw", type: "tool", subtype: "saw", rarity: "common", value: 10, durability: 70 },
    "copper_saw": { name: "Copper Saw", type: "tool", subtype: "saw", rarity: "common", value: 10, durability: 70 },
    "bronze_saw": { name: "Bronze Saw", type: "tool", subtype: "saw", rarity: "uncommon", value: 50, durability: 80 },
    "iron_saw": { name: "Iron Saw", type: "tool", subtype: "saw", rarity: "common", value: 11, durability: 75 },
    "steel_saw": { name: "Steel Saw", type: "tool", subtype: "saw", rarity: "uncommon", value: 50, durability: 80 },
    "mithril_saw": { name: "Mithril Saw", type: "tool", subtype: "saw", rarity: "epic", value: 250, durability: 150 },
    "adamantite_saw": { name: "Adamantite Saw", type: "tool", subtype: "saw", rarity: "legendary", value: 350, durability: 200 },
    "syllic_saw": { name: "Syllic Saw", type: "tool", subtype: "saw", rarity: "mythic", value: 650, durability: 250 },
    // - - Axes
    "tin_axe": { name: "Tin Axe", type: "tool", subtype: "axe", rarity: "common", value: 10, durability: 70 },
    "copper_axe": { name: "Copper Axe", type: "tool", subtype: "axe", rarity: "common", value: 10, durability: 70 },
    "bronze_axe": { name: "Bronze Axe", type: "tool", subtype: "axe", rarity: "uncommon", value: 50, durability: 80 },
    "iron_axe": { name: "Iron Axe", type: "tool", subtype: "axe", rarity: "common", value: 11, durability: 75 },
    "steel_axe": { name: "Steel Axe", type: "tool", subtype: "axe", rarity: "uncommon", value: 50, durability: 80 },
    "mithril_axe": { name: "Mithril Axe", type: "tool", subtype: "axe", rarity: "epic", value: 250, durability: 150 },
    "adamantite_axe": { name: "Adamantite Axe", type: "tool", subtype: "axe", rarity: "legendary", value: 350, durability: 200 },
    "syllic_axe": { name: "Syllic Axe", type: "tool", subtype: "axe", rarity: "mythic", value: 650, durability: 250 },
    // - - Fishing Rods
    "tin_fishing_rod": { name: "Tin Fishing Rod", type: "tool", subtype: "fishing rod", rarity: "common", value: 10, durability: 70 },
    "copper_fishing_rod": { name: "Copper Fishing Rod", type: "tool", subtype: "fishing rod", rarity: "common", value: 10, durability: 70 },
    "bronze_fishing_rod": { name: "Bronze Fishing Rod", type: "tool", subtype: "fishing rod", rarity: "uncommon", value: 50, durability: 80 },
    "iron_fishing_rod": { name: "Iron Fishing Rod", type: "tool", subtype: "fishing rod", rarity: "common", value: 11, durability: 75 },
    "steel_fishing_rod": { name: "Steel Fishing Rod", type: "tool", subtype: "fishing rod", rarity: "uncommon", value: 50, durability: 80 },
    "mithril_fishing_rod": { name: "Mithril Fishing Rod", type: "tool", subtype: "fishing rod", rarity: "epic", value: 250, durability: 150 },
    "adamantite_fishing_rod": { name: "Adamantite Fishing Rod", type: "tool", subtype: "fishing rod", rarity: "legendary", value: 350, durability: 200 },
    "syllic_fishing_rod": { name: "Syllic Fishing Rod", type: "tool", subtype: "fishing rod", rarity: "mythic", value: 650, durability: 250 },
    // - - Pickaxes
    "tin_pickaxe": { name: "Tin Pickaxe", type: "tool", subtype: "pickaxe", rarity: "common", value: 10, durability: 70 },
    "copper_pickaxe": { name: "Copper Pickaxe", type: "tool", subtype: "pickaxe", rarity: "common", value: 10, durability: 70 },
    "bronze_pickaxe": { name: "Bronze Pickaxe", type: "tool", subtype: "pickaxe", rarity: "uncommon", value: 50, durability: 80 },
    "iron_pickaxe": { name: "Iron Pickaxe", type: "tool", subtype: "pickaxe", rarity: "common", value: 11, durability: 75 },
    "steel_pickaxe": { name: "Steel Pickaxe", type: "tool", subtype: "pickaxe", rarity: "uncommon", value: 50, durability: 80 },
    "mithril_pickaxe": { name: "Mithril Pickaxe", type: "tool", subtype: "pickaxe", rarity: "epic", value: 250, durability: 150 },
    "adamantite_pickaxe": { name: "Adamantite Pickaxe", type: "tool", subtype: "pickaxe", rarity: "legendary", value: 350, durability: 200 },
    "syllic_pickaxe": { name: "Syllic Pickaxe", type: "tool", subtype: "pickaxe", rarity: "mythic", value: 650, durability: 250 },

    // Kits
    // - Basic Kits
    "first_aid_kit": { name: "First Aid Kit", type: "kit", subtype: "first_aid", rarity: "uncommon", value: 25, contents: ["healing_potion", "bandage"] },
    "survival_kit": { name: "Survival Kit", type: "kit", subtype: "survival", rarity: "rare", value: 75, contents: ["healing_potion", "mana_potion", "bread"] },
    "tool_kit": { name: "Tool Kit", type: "kit", subtype: "tool", rarity: "uncommon", value: 25, contents: ["hammer", "shovel", "saw"] },
    "crafting_kit": { name: "Crafting Kit", type: "kit", subtype: "crafting", rarity: "rare", value: 75, contents: {"hammer": 1, "shovel": 1, "wood": 3, "iron_bar": 2} },
    // - Advanced Kits
    "advanced_first_aid_kit": { name: "Advanced First Aid Kit", type: "kit", subtype: "first_aid", rarity: "rare", value: 100, contents: {"healing_potion": 3, "mana_potion": 2, "bandage": 5} },
    "advanced_survival_kit": { name: "Advanced Survival Kit", type: "kit", subtype: "survival", rarity: "epic", value: 150, contents: {"healing_potion": 5, "mana_potion": 3, "bread": 2, "empty_bottle": 3} },
    "advanced_tool_kit": { name: "Advanced Tool Kit", type: "kit", subtype: "tool", rarity: "rare", value: 75, contents: {"hammer": 1, "shovel": 1, "saw": 1, "axe": 1, "fishing_rod": 1, "iron_pickaxe": 1} },
    // - Armor Kits
    "bronze_helmet_kit": { name: "Bronze Helmet Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 25, recipes: ["bronze_helmet"] },
    "bronze_chestplate_kit": { name: "Bronze Chestplate Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 35, recipes: ["bronze_chestplate"] },
    "bronze_leggings_kit": { name: "Bronze Leggings Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 25, recipes: ["bronze_leggings"] },
    "bronze_boots_kit": { name: "Bronze Boots Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 25, recipes: ["bronze_boots"] },
    "bronze_gauntlets_kit": { name: "Bronze Gauntlets Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 25, recipes: ["bronze_gauntlets"] },
    "iron_helmet_kit": { name: "Iron Helmet Kit", type: "kit", subtype: "armor", rarity: "common", value: 5, recipes: ["iron_helmet"] },
    "iron_chestplate_kit": { name: "Iron Chestplate Kit", type: "kit", subtype: "armor", rarity: "common", value: 10, recipes: ["iron_chestplate"] },
    "iron_leggings_kit": { name: "Iron Leggings Kit", type: "kit", subtype: "armor", rarity: "common", value: 7, recipes: ["iron_leggings"] },
    "iron_boots_kit": { name: "Iron Boots Kit", type: "kit", subtype: "armor", rarity: "common", value: 5, recipes: ["iron_boots"] },
    "iron_gauntlets_kit": { name: "Iron Gauntlets Kit", type: "kit", subtype: "armor", rarity: "common", value: 5, recipes: ["iron_gauntlets"] },
    "steel_helmet_kit": { name: "Steel Helmet Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 25, recipes: ["steel_helmet"] },
    "steel_chestplate_kit": { name: "Steel Chestplate Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 40, recipes: ["steel_chestplate"] },
    "steel_leggings_kit": { name: "Steel Leggings Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 35, recipes: ["steel_leggings"] },
    "steel_boots_kit": { name: "Steel Boots Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 25, recipes: ["steel_boots"] },
    "steel_gauntlets_kit": { name: "Steel Gauntlets Kit", type: "kit", subtype: "armor", rarity: "uncommon", value: 25, recipes: ["steel_gauntlets"] },
    "mithril_helmet_kit": { name: "Mithril Helmet Kit", type: "kit", subtype: "armor", rarity: "epic", value: 130, recipes: ["mithril_helmet"] },
    "mithril_chestplate_kit": { name: "Mithril Chestplate Kit", type: "kit", subtype: "armor", rarity: "epic", value: 160, recipes: ["mithril_chestplate"] },
    "mithril_leggings_kit": { name: "Mithril Leggings Kit", type: "kit", subtype: "armor", rarity: "epic", value: 140, recipes: ["mithril_leggings"] },
    "mithril_boots_kit": { name: "Mithril Boots Kit", type: "kit", subtype: "armor", rarity: "epic", value: 130, recipes: ["mithril_boots"] },
    "mithril_gauntlets_kit": { name: "Mithril Gauntlets Kit", type: "kit", subtype: "armor", rarity: "epic", value: 130, recipes: ["mithril_gauntlets"] },
    "adamantite_helmet_kit": { name: "Adamantite Helmet Kit", type: "kit", subtype: "armor", rarity: "legendary", value: 180, recipes: ["adamantite_helmet"] },
    "adamantite_chestplate_kit": { name: "Adamantite Chestplate Kit", type: "kit", subtype: "armor", rarity: "legendary", value: 200, recipes: ["adamantite_chestplate"] },
    "adamantite_leggings_kit": { name: "Adamantite Leggings Kit", type: "kit", subtype: "armor", rarity: "legendary", value: 190, recipes: ["adamantite_leggings"] },
    "adamantite_boots_kit": { name: "Adamantite Boots Kit", type: "kit", subtype: "armor", rarity: "legendary", value: 180, recipes: ["adamantite_boots"] },
    "adamantite_gauntlets_kit": { name: "Adamantite Gauntlets Kit", type: "kit", subtype: "armor", rarity: "legendary", value: 180, recipes: ["adamantite_gauntlets"] },
    
    // Sets
    // - Armor Sets
    "bronze_armor_set": { name: "Bronze Set", type: "set", subtype: "armor", rarity: "uncommon", value: 210, items: ["bronze_helmet", "bronze_chestplate", "bronze_leggings", "bronze_boots", "bronze_gauntlets"] },
    "iron_armor_set": { name: "Iron Set", type: "set", subtype: "armor", rarity: "common", value: 55, items: ["iron_helmet", "iron_chestplate", "iron_leggings", "iron_boots", "iron_gauntlets"] },
    "steel_armor_set": { name: "Steel Set", type: "set", subtype: "armor", rarity: "uncommon", value: 260, items: ["steel_helmet", "steel_chestplate", "steel_leggings", "steel_boots", "steel_gauntlets"] },
    "mithril_armor_set": { name: "Mithril Set", type: "set", subtype: "armor", rarity: "epic", value: 1200, items: ["mithril_helmet", "mithril_chestplate", "mithril_leggings", "mithril_boots", "mithril_gauntlets"] },
    "adamantite_armor_set": { name: "Adamantite Set", type: "set", subtype: "armor", rarity: "legendary", value: 1650, items: ["adamantite_helmet", "adamantite_chestplate", "adamantite_leggings", "adamantite_boots", "adamantite_gauntlets"] },
    // - Weapon Sets
    "bronze_weapon_set": { name: "Bronze Weapon Set", type: "set", subtype: "weapon", rarity: "uncommon", value: 120, items: ["bronze_sword", "bronze_dagger", "bronze_bow"] },
    "iron_weapon_set": { name: "Iron Weapon Set", type: "set", subtype: "weapon", rarity: "common", value: 35, items: ["iron_sword", "iron_dagger", "iron_bow"] },
    "steel_weapon_set": { name: "Steel Weapon Set", type: "set", subtype: "weapon", rarity: "uncommon", value: 190, items: ["steel_sword", "steel_dagger", "steel_bow"] },
    "mithril_weapon_set": { name: "Mithril Weapon Set", type: "set", subtype: "weapon", rarity: "epic", value: 610, items: ["mithril_sword", "mithril_dagger", "mithril_bow"] },
    "adamantite_weapon_set": { name: "Adamantite Weapon Set", type: "set", subtype: "weapon", rarity: "legendary", value: 860, items: ["adamantite_sword", "adamantite_dagger", "adamantite_bow"] },
    // - Tool Sets
    "basic_tool_set": { name: "Basic Tool Set", type: "set", subtype: "tool", rarity: "common", value: 23, items: ["hammer", "shovel", "saw"] },
    "advanced_tool_set": { name: "Advanced Tool Set", type: "set", subtype: "tool", rarity: "uncommon", value: 280, items: ["iron_pickaxe", "steel_shovel", "mithril_saw"] },
    // - Crafting Sets
    "basic_crafting_set": { name: "Basic Crafting Set", type: "set", subtype: "crafting", rarity: "common", value: 120, items: { "hammer": 1, "shovel": 1, "saw": 1, "wood": 5, "leather": 5, "string": 2, "empty_bottle": 2 } },
    "advanced_crafting_set": { name: "Advanced Crafting Set", type: "set", subtype: "crafting", rarity: "uncommon", value: 710, items: { "iron_pickaxe": 1, "steel_shovel": 1, "mithril_saw": 1, "mithril_bar": 5, "wood": 8, "leather": 8, "string": 5, "empty_bottle": 5, "bone": 2 } },
    "fletching_set": { name: "Fletching Set", type: "set", subtype: "crafting", rarity: "uncommon", value: 170, items: { "wood": 5, "feather": 10, "string": 5, "iron_bar": 2 } },
    "smithing_set": { name: "Smithing Set", type: "set", subtype: "crafting", rarity: "uncommon", value: 380, items: { "iron_bar": 5, "steel_bar": 3, "mithril_bar": 2, "adamantite_bar": 1, "hammer": 1 } },
    ...
    "raw_mushroom": { name: "Raw Mushroom", type: "food", subtype: "raw_fungi", gather: "forage", rarity: "common", value: 22, health_boost: 5 },
    "raw_vegetables": { name: "Raw Vegetables", type: "food", subtype: "raw_vegetables", gather: "forage", rarity: "common", value: 22, health_boost: 5 },
    "raw_herbs": { name: "Raw Herbs", type: "food", subtype: "raw_herbs", gather: "forage", rarity: "common", value: 22, health_boost: 5 },
    "raw_fruits": { name: "Raw Fruits", type: "food", subtype: "raw_food", gather: "forage", rarity: "common", value: 22, health_boost: 5 },

    // Inedible Raw Foods
    "raw_rabbit": { name: "Raw Rabbit", type: "food", subtype: "raw_meat", gather: "hunt", rarity: "common", value: 22, health_boost: 5 },
    "raw_chicken": { name: "Raw Chicken", type: "food", subtype: "raw_meat", gather: "hunt", rarity: "common", value: 22, health_boost: 5 },
    "raw_beef": { name: "Raw Beef", type: "food", subtype: "raw_meat", gather: "hunt", rarity: "common", value: 22, health_boost: 5 },
    "raw_pork": { name: "Raw Pork", type: "food", subtype: "raw_meat", gather: "hunt", rarity: "common", value: 22, health_boost: 5 },
    "raw_venison": { name: "Raw Venison", type: "food", subtype: "raw_meat", gather: "hunt", rarity: "common", value: 22, health_boost: 5 },
    "raw_duck": { name: "Raw Duck", type: "food", subtype: "raw_meat", gather: "hunt", rarity: "common", value: 22, health_boost: 5 },

    // Ingredients for Cooking (foragable, uses raw_food subtype)
    "salt": { name: "Salt", type: "food", subtype: "raw_food", rarity: "common", value: 8, health_boost: 1 },
    "vinegar": { name: "Vinegar", type: "food", subtype: "raw_food", rarity: "common", value: 8, health_boost: 1 },
    "oil": { name: "Oil", type: "food", subtype: "raw_food", rarity: "common", value: 8, health_boost: 1 },
    "peppercorn": { name: "Peppercorn", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "pepper_flakes": { name: "Pepper Flakes", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "spices": { name: "Spices", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "herbs": { name: "Herbs", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "garlic_clove": { name: "Garlic Clove", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "onion_slice": { name: "Onion Slice", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "lemon": { name: "Lemon", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "lime": { name: "Lime", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "cinnamon_stick": { name: "Cinnamon Stick", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "nutmeg": { name: "Nutmeg", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "clove": { name: "Clove", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "bay_leaf": { name: "Bay Leaf", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "rosemary": { name: "Rosemary", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "thyme": { name: "Thyme", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "oregano": { name: "Oregano", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "basil": { name: "Basil", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "parsley": { name: "Parsley", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "dill": { name: "Dill", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "sage": { name: "Sage", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "tarragon": { name: "Tarragon", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "chili_pepper": { name: "Chili Pepper", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "paprika": { name: "Paprika", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "cayenne_pepper": { name: "Cayenne Pepper", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "saffron": { name: "Saffron", type: "food", subtype: "raw_food", rarity: "rare", value: 100, health_boost: 5 },
    "vanilla_bean": { name: "Vanilla Bean", type: "food", subtype: "raw_food", rarity: "rare", value: 100, health_boost: 5 },
    "cocoa_powder": { name: "Cocoa Powder", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "coffee_beans": { name: "Coffee Beans", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "tea_leaves": { name: "Tea Leaves", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "honey": { name: "Honey", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "maple_syrup": { name: "Maple Syrup", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "eggs": { name: "Eggs", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "cream": { name: "Cream", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "cheese": { name: "Cheese", type: "food", subtype: "raw_food", rarity: "common", value: 15, health_boost: 3 },
    "green_tea_leaves": { name: "Green Tea Leaves", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "black_tea_leaves": { name: "Black Tea Leaves", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "white_tea_leaves": { name: "White Tea Leaves", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "herbal_tea_leaves": { name: "Herbal Tea Leaves", type: "food", subtype: "raw_food", rarity: "common", value: 11, health_boost: 2 },
    "matcha_powder": { name: "Matcha Powder", type: "food", subtype: "raw_food", rarity: "rare", value: 100, health_boost: 5 },

    // Non-forageable ingredients (subtypes: ingredient, pastry, dough, etc. - NOT raw_food)
    "flour": { name: "Flour", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "sugar": { name: "Sugar", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "yeast": { name: "Yeast", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "butter": { name: "Butter", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "milk": { name: "Milk", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "baking_powder": { name: "Baking Powder", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "baking_soda": { name: "Baking Soda", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "pie_crust": { name: "Pie Crust", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "cake_mix": { name: "Cake Mix", type: "food", subtype: "ingredient", rarity: "common", value: 8 },
    "bread_dough": { name: "Bread Dough", type: "food", subtype: "ingredient", rarity: "common", value: 8 },

    // Fruits 
    "apple": { name: "Apple", type: "food", subtype: "raw_fruits", rarity: "common", value: 22, health_boost: 5 },
    "banana": { name: "Banana", type: "food", subtype: "raw_fruits", rarity: "common", value: 22, health_boost: 5 },
    "orange": { name: "Orange", type: "food", subtype: "raw_fruits", rarity: "common", value: 22, health_boost: 5 },
    "grape": { name: "Grape", type: "food", subtype: "raw_fruits", rarity: "common", value: 22, health_boost: 5 },
    "strawberry": { name: "Strawberry", type: "food", subtype: "raw_fruits", rarity: "common", value: 22, health_boost: 5 },
    "peach": { name: "Peach", type: "food", subtype: "raw_fruits", rarity: "common", value: 22, health_boost: 5 },
    
    // Vegetables
    "carrot": { name: "Carrot", type: "food", subtype: "raw_vegetables", rarity: "common", value: 22, health_boost: 5 },
    "potato": { name: "Potato", type: "food", subtype: "raw_vegetables", rarity: "common", value: 22, health_boost: 5 },
    "tomato": { name: "Tomato", type: "food", subtype: "raw_vegetables", rarity: "common", value: 22, health_boost: 5 },
    "onion": { name: "Onion", type: "food", subtype: "raw_vegetables", rarity: "common", value: 22, health_boost: 5 },
    "garlic": { name: "Garlic", type: "food", subtype: "raw_vegetables", rarity: "common", value: 22, health_boost: 5 },
    "pepper": { name: "Pepper", type: "food", subtype: "raw_vegetables", rarity: "common", value: 22, health_boost: 5 },
    "cucumber": { name: "Cucumber", type: "food", subtype: "raw_vegetables", rarity: "common", value: 22, health_boost: 5 },
    "lettuce": { name: "Lettuce", type: "food", subtype: "raw_vegetables", rarity: "common", value: 22, health_boost: 5 },

    // Herbs and Mushrooms for potions and cooking
    "green_herbs": { name: "Green Herbs", type: "food", subtype: "raw_herbs", rarity: "common", value: 22, health_boost: 5 },
    "red_herbs": { name: "Red Herbs", type: "food", subtype: "raw_herbs", rarity: "common", value: 22, health_boost: 5 },
    "yellow_herbs": { name: "Yellow Herbs", type: "food", subtype: "raw_herbs", rarity: "common", value: 22, health_boost: 5 },
    "blue_herbs": { name: "Blue Herbs", type: "food", subtype: "raw_herbs", rarity: "common", value: 22, health_boost: 5 },
    "purple_herbs": { name: "Purple Herbs", type: "food", subtype: "raw_herbs", rarity: "common", value: 22, health_boost: 5 },
    "white_herbs": { name: "White Herbs", type: "food", subtype: "raw_herbs", rarity: "common", value: 22, health_boost: 5 },
    "black_herbs": { name: "Black Herbs", type: "food", subtype: "raw_herbs", rarity: "common", value: 22, health_boost: 5 },
    "red_mushroom": { name: "Red Mushroom", type: "food", subtype: "raw_fungi", rarity: "common", value: 22, health_boost: 5 },
    "green_mushroom": { name: "Green Mushroom", type: "food", subtype: "raw_fungi", rarity: "common", value: 22, health_boost: 5 },
    "blue_mushroom": { name: "Blue Mushroom", type: "food", subtype: "raw_fungi", rarity: "common", value: 22, health_boost: 5 },
    "yellow_mushroom": { name: "Yellow Mushroom", type: "food", subtype: "raw_fungi", rarity: "common", value: 22, health_boost: 5 },
    "purple_mushroom": { name: "Purple Mushroom", type: "food", subtype: "raw_fungi", rarity: "common", value: 22, health_boost: 5 },
    "white_mushroom": { name: "White Mushroom", type: "food", subtype: "raw_fungi", rarity: "common", value: 22, health_boost: 5 },
    "black_mushroom": { name: "Black Mushroom", type: "food", subtype: "raw_fungi", rarity: "common", value: 22, health_boost: 5 },
    "red_berry": { name: "Red Berry", type: "food", subtype: "raw_food", rarity: "common", value: 22, health_boost: 5 },
    "green_berry": { name: "Green Berry", type: "food", subtype: "raw_food", rarity: "common", value: 22, health_boost: 5 },
    "blue_berry": { name: "Blue Berry", type: "food", subtype: "raw_food", rarity: "common", value: 22, health_boost: 5 },
    "yellow_berry": { name: "Yellow Berry", type: "food", subtype: "raw_food", rarity: "common", value: 22, health_boost: 5 },
    "purple_berry": { name: "Purple Berry", type: "food", subtype: "raw_food", rarity: "common", value: 22, health_boost: 5 },
    "white_berry": { name: "White Berry", type: "food", subtype: "raw_food", rarity: "common", value: 22, health_boost: 5 },
    "black_berry": { name: "Black Berry", type: "food", subtype: "raw_food", rarity: "common", value: 22, health_boost: 5 },

    // Basic Cooked Food
    "cooked_rabbit": { name: "Cooked Rabbit", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_chicken": { name: "Cooked Chicken", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_beef": { name: "Cooked Beef", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_pork": { name: "Cooked Pork", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_venison": { name: "Cooked Venison", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_duck": { name: "Cooked Duck", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    ...
    "cooked_mushroom": { name: "Cooked Mushroom", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_vegetables": { name: "Cooked Vegetables", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_fruits": { name: "Cooked Fruits", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_herbs": { name: "Cooked Herbs", type: "food", subtype: "cooked_food", rarity: "common", value: 25, health_boost: 15 },
    "cooked_stew": { name: "Cooked Stew", type: "food", subtype: "stew", rarity: "uncommon", value: 95, health_boost: 25 },

    // Mixed Cooked Foods
    "meat_stew": { name: "Meat Stew", type: "food", subtype: "stew", rarity: "uncommon", value: 110, health_boost: 30 },
    "vegetable_stew": { name: "Vegetable Stew", type: "food", subtype: "stew", rarity: "uncommon", value: 110, health_boost: 30 },
    "fruit_stew": { name: "Fruit Stew", type: "food", subtype: "stew", rarity: "uncommon", value: 110, health_boost: 30 },
    "colorful_herb_stew": { name: "Colorful Herb Stew", type: "food", subtype: "stew", rarity: "uncommon", value: 110, health_boost: 30 },
    "mixed_herb_stew":  { name: "Mixed Herb Stew", type: "food", subtype: "stew", rarity: "rare", value: 150, health_boost: 40 },
    "vibrant_herb_stew": { name: "Vibrant Herb Stew", type: "food", subtype: "stew", rarity: "rare", value: 180, health_boost: 50 },
    "ultimate_herb_stew": { name: "Ultimate Herb Stew", type: "food", subtype: "stew", rarity: "epic", value: 270, health_boost: 75 },
    "colorful_mushroom_stew": { name: "Colorful Mushroom Stew", type: "food", subtype: "stew", rarity: "rare", value: 180, health_boost: 50 },
    "mixed_mushroom_stew": { name: "Mixed Mushroom Stew", type: "food", subtype: "stew", rarity: "rare", value: 220, health_boost: 60 },
    "vibrant_mushroom_stew": { name: "Vibrant Mushroom Stew", type: "food", subtype: "stew", rarity: "epic", value: 290, health_boost: 80 },
    "ultimate_mushroom_stew": { name: "Ultimate Mushroom Stew", type: "food", subtype: "stew", rarity: "legendary", value: 360, health_boost: 100 },
    "mixed_berry_stew": { name: "Mixed Berry Stew", type: "food", subtype: "stew", rarity: "rare", value: 220, health_boost: 60 },
    "vibrant_berry_stew": { name: "Vibrant Berry Stew", type: "food", subtype: "stew", rarity: "epic", value: 290, health_boost: 80 },
    "ultimate_berry_stew": { name: "Ultimate Berry Stew", type: "food", subtype: "stew", rarity: "legendary", value: 360, health_boost: 100 },

    // Advanced Cooked Foods
    "gourmet_meat_stew": { name: "Gourmet Meat Stew", type: "food", subtype: "stew", rarity: "epic", value: 290, health_boost: 80 },
    "gourmet_vegetable_stew": { name: "Gourmet Vegetable Stew", type: "food", subtype: "stew", rarity: "epic", value: 290, health_boost: 80 },
    "gourmet_fruit_stew": { name: "Gourmet Fruit Stew", type: "food", subtype: "stew", rarity: "epic", value: 290, health_boost: 80 },
    "gourmet_herb_stew": { name: "Gourmet Herb Stew", type: "food", subtype: "stew", rarity: "epic", value: 290, health_boost: 80 },
    "gourmet_mushroom_stew": { name: "Gourmet Mushroom Stew", type: "food", subtype: "stew", rarity: "epic", value: 290, health_boost: 80 },
    "gourmet_berry_stew": { name: "Gourmet Berry Stew", type: "food", subtype: "stew", rarity: "epic", value: 290, health_boost: 80 },
    "ultimate_gourmet_stew": { name: "Ultimate Gourmet Stew", type: "food", subtype: "stew", rarity: "legendary", value: 440, health_boost: 120 },
    
    // Basic Baked Goods
    "bread": { name: "Bread", type: "food", subtype: "baked", rarity: "common", value: 25, health_boost: 10 },
    "golden_apple": { name: "Golden Apple", type: "food", subtype: "baked", rarity: "rare", value: 100, health_boost: 20 },
    "cookies": { name: "Cookies", type: "food", subtype: "baked", rarity: "uncommon", value: 75, health_boost: 20 },
    "cake": { name: "Cake", type: "food", subtype: "baked", rarity: "rare", value: 110, health_boost: 30 },
    "pie": { name: "Pie", type: "food", subtype: "baked", rarity: "rare", value: 110, health_boost: 30 },

    // Mixed Baked Goods
    "fruit_pie": { name: "Fruit Pie", type: "food", subtype: "baked", rarity: "rare", value: 110, health_boost: 30 },
    "mixed_fruit_pie": { name: "Mixed Fruit Pie", type: "food", subtype: "baked", rarity: "epic", value: 180, health_boost: 40 },
    "vibrant_fruit_pie": { name: "Vibrant Fruit Pie", type: "food", subtype: "baked", rarity: "epic", value: 180, health_boost: 50 },
    "ultimate_fruit_pie": { name: "Ultimate Fruit Pie", type: "food", subtype: "baked", rarity: "legendary", value: 250, health_boost: 60 },
    "berry_pie": { name: "Berry Pie", type: "food", subtype: "baked", rarity: "rare", value: 110, health_boost: 30 },
    "mushroom_pie": { name: "Mushroom Pie", type: "food", subtype: "baked", rarity: "rare", value: 110, health_boost: 30 },
    "mixed_mushroom_pie": { name: "Mixed Mushroom Pie", type: "food", subtype: "baked", rarity: "epic", value: 180, health_boost: 40 },
    "vibrant_mushroom_pie": { name: "Vibrant Mushroom Pie", type: "food", subtype: "baked", rarity: "epic", value: 180, health_boost: 50 },
    "ultimate_mushroom_pie": { name: "Ultimate Mushroom Pie", type: "food", subtype: "baked", rarity: "legendary", value: 250, health_boost: 60 },
    "herb_bread": { name: "Herb Bread", type: "food", subtype: "baked", rarity: "uncommon", value: 75, health_boost: 20 },
    "mixed_herb_bread": { name: "Mixed Herb Bread", type: "food", subtype: "baked", rarity: "rare", value: 110, health_boost: 30 },
    "vibrant_herb_bread": { name: "Vibrant Herb Bread", type: "food", subtype: "baked", rarity: "epic", value: 180, health_boost: 40 },
    "ultimate_herb_bread": { name: "Ultimate Herb Bread", type: "food", subtype: "baked", rarity: "legendary", value: 250, health_boost: 50 },

    // Advanced Baked Goods
    "gourmet_fruit_pie": { name: "Gourmet Fruit Pie", type: "food", subtype: "baked", rarity: "epic", value: 180, health_boost: 50 },
    "gourmet_mushroom_pie": { name: "Gourmet Mushroom Pie", type: "food", subtype: "baked", rarity: "epic", value: 180, health_boost: 50 },
    "gourmet_herb_bread": { name: "Gourmet Herb Bread", type: "food", subtype: "baked", rarity: "epic", value: 180, health_boost: 50 },
    "ultimate_gourmet_baked_goods": { name: "Ultimate Gourmet Baked Goods", type: "food", subtype: "baked", rarity: "legendary", value: 270, health_boost: 75 },

    // Brewed Drinks
    // - Teas
    "herbal_tea": { name: "Herbal Tea", type: "food", subtype: "brewed", rarity: "uncommon", value: 55, health_boost: 15 },
    "green_tea": { name: "Green Tea", type: "food", subtype: "brewed", rarity: "uncommon", value: 25, health_boost: 15 },
    "black_tea": { name: "Black Tea", type: "food", subtype: "brewed", rarity: "uncommon", value: 25, health_boost: 15 },
    "white_tea": { name: "White Tea", type: "food", subtype: "brewed", rarity: "uncommon", value: 25, health_boost: 15 },
    // - Fruit Juices
    "fruit_juice": { name: "Fruit Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "peach_juice": { name: "Peach Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "apple_juice": { name: "Apple Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "grape_juice": { name: "Grape Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "orange_juice": { name: "Orange Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    // - Berry Juices
    "red_berry_juice": { name: "Red Berry Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "green_berry_juice": { name: "Green Berry Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "blue_berry_juice": { name: "Blue Berry Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "yellow_berry_juice": { name: "Yellow Berry Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "purple_berry_juice": { name: "Purple Berry Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "white_berry_juice": { name: "White Berry Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "black_berry_juice": { name: "Black Berry Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "berry_juice": { name: "Berry Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    // - Vegetable Juices
    "citrus_juice": { name: "Citrus Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "vegetable_juice": { name: "Vegetable Juice", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    // - Coffee and Cocoa
    "coffee": { name: "Coffee", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },
    "cocoa": { name: "Cocoa", type: "food", subtype: "brewed", rarity: "uncommon", value: 60, health_boost: 15 },

    // - Mixed Brews
    "mushroom_brew": { name: "Mushroom Brew", type: "food", subtype: "brewed", rarity: "rare", value: 100, health_boost: 20 },
    "berry_brew": { name: "Berry Brew", type: "food", subtype: "brewed", rarity: "rare", value: 100, health_boost: 20 },
    "mixed_herb_brew": { name: "Mixed Herb Brew", type: "food", subtype: "brewed", rarity: "epic", value: 160, health_boost: 30 },
    "vibrant_herb_brew": { name: "Vibrant Herb Brew", type: "food", subtype: "brewed", rarity: "epic", value: 160, health_boost: 40 },
    "ultimate_herb_brew": { name: "Ultimate Herb Brew", type: "food", subtype: "brewed", rarity: "legendary", value: 250, health_boost: 50 },

    // Basic Items
    "wood": { name: "Wood", type: "crafting", subtype: "wood", gather: "chop", rarity: "common", value: 8 },
    "leather": { name: "Leather", type: "crafting", subtype: "raw", gather: "tan", rarity: "common", value: 8 },
    "string": { name: "String", type: "crafting", subtype: "string", rarity: "common", value: 8 },
    "firewood": { name: "Firewood", type: "crafting", subtype: "wood", gather: "chop", rarity: "common", value: 4 },
    "sinew": { name: "Sinew", type: "crafting", subtype: "fiber", gather: "hunt", rarity: "common", value: 8 },
    "flint": { name: "Flint", type: "crafting", subtype: "stone", rarity: "common", value: 8 },
    "bone": { name: "Bone", type: "crafting", subtype: "bone", gather: "hunt", rarity: "common", value: 8 },
    "feather": { name: "Feather", type: "crafting", subtype: "raw", gather: "hunt", rarity: "common", value: 8 },
    "clay": { name: "Clay", type: "crafting", subtype: "raw", gather: "mine", rarity: "common", value: 8 },
    "sand": { name: "Sand", type: "crafting", subtype: "raw", gather: "mine", rarity: "common", value: 8 },
    "empty_bottle": { name: "Empty Bottle", type: "crafting", subtype: "glass", gather: "forage", rarity: "common", value: 8 },

    // Mining ores
    "tin_ore": { name: "Tin Ore", type: "mining", subtype: "tin", rarity: "common", value: 4 },
    "copper_ore": { name: "Copper Ore", type: "mining", subtype: "copper", rarity: "common", value: 4 },
    "iron_ore": { name: "Iron Ore", type: "mining", subtype: "iron", rarity: "common", value: 9 },
    "gold_ore": { name: "Gold Ore", type: "mining", subtype: "gold", rarity: "uncommon", value: 13 },
    "cobalt_ore": { name: "Cobalt Ore", type: "mining", subtype: "cobalt", rarity: "uncommon", value: 15 },
    "mithril_ore": { name: "Mithril Ore", type: "mining", subtype: "mithril", rarity: "rare", value: 35 },
    "runite_ore": { name: "Runite Ore", type: "mining", subtype: "runite", rarity: "epic", value: 75 },
    "adamantite_ore": { name: "Adamantite Ore", type: "mining", subtype: "adamantite", rarity: "legendary", value: 55 },
    "syllic_ore": { name: "Syllic Ore", type: "mining", subtype: "syllic", rarity: "legendary", value: 50 },
    
    // Smithing bars
    "tin_bar": { name: "Tin Bar", type: "smithing", subtype: "tin", rarity: "common", value: 6 },
    "copper_bar": { name: "Copper Bar", type: "smithing", subtype: "copper", rarity: "common", value: 6 },
    "bronze_bar": { name: "Bronze Bar", type: "smithing", subtype: "alloy", rarity: "uncommon", value: 18 },
    "iron_bar": { name: "Iron Bar", type: "smithing", subtype: "iron", rarity: "common", value: 14 },
    "gold_bar": { name: "Gold Bar", type: "smithing", subtype: "gold", rarity: "uncommon", value: 19 },
    "cobalt_bar": { name: "Cobalt Bar", type: "smithing", subtype: "cobalt", rarity: "uncommon", value: 23 },
    "black_cobalt_bar": { name: "Black Cobalt Bar", type: "smithing", subtype: "cobalt", rarity: "rare", value: 23 },
    "steel_bar": { name: "Steel Bar", type: "smithing", subtype: "alloy", rarity: "uncommon", value: 55 },
    "black_steel_bar": { name: "Black Steel Bar", type: "smithing", subtype: "alloy", rarity: "rare", value: 120 },
    "mithril_bar": { name: "Mithril Bar", type: "smithing", subtype: "mithril", rarity: "rare", value: 50 },
    "runite_bar": { name: "Runite Bar", type: "smithing", subtype: "runite", rarity: "epic", value: 110 },
    "adamantite_bar": { name: "Adamantite Bar", type: "smithing", subtype: "adamantite", rarity: "legendary", value: 85 },
    "syllic_bar": { name: "Syllic Bar", type: "smithing", subtype: "syllic", rarity: "legendary", value: 75 },

};

export const TOOLBELTS = {
    global: { type: "armor", slot: "belt" },
    "leather_belt": { name: "Leather Belt", subtype: "leather", rarity: "common", value: 10, belt: { slingAmmo: 10, potions: 5, backpack: 100 }, description: "A simple leather belt, providing basic utility and storage." },
    "chainmail_belt": { name: "Chainmail Belt", subtype: "chainmail", rarity: "uncommon", value: 45, belt: { slingAmmo: 15, potions: 10, backpack: 150 }, description: "A belt made of interlocking metal rings, providing moderate protection and utility." },
    "adventurer_belt": { name: "Adventurer Belt", subtype: "adventurer", rarity: "uncommon", value: 55, belt: { slingAmmo: 15, potions: 10, backpack: 175 }, description: "A belt favored by adventurers for its practicality and durability." },
    "plate_belt": { name: "Plate Belt", subtype: "plate", rarity: "rare", value: 150, belt: { slingAmmo: 20, potions: 15, backpack: 200 }, description: "A sturdy belt made of plate armor." },
    "mythic_belt": { name: "Mythic Belt", subtype: "mythic", rarity: "mythic", value: 500, belt: { slingAmmo: 30, potions: 20, backpack: 300 }, buff: ["attack"], description: "A legendary belt said to be imbued with the power of the gods, granting its wearer unparalleled abilities." },
...
export const MYTHIC_ITEMS = {
    ...
    "mythic_dagger": { name: "Mythic Dagger", type: "weapon", subtype: "dagger", rarity: "mythic", value: 650, damage: 75, buff: ["attack"], description: "A dagger of legendary power, said to be forged by the gods themselves." },
    "mythic_slingshot": { name: "Mythic Slingshot", type: "weapon", subtype: "slingshot", rarity: "mythic", value: 530, damage: 60, buff: ["attack"], description: "A slingshot of legendary power, said to be forged by the gods themselves." },
    "mythic_bow": { name: "Mythic Bow", type: "weapon", subtype: "bow", rarity: "mythic", value: 770, damage: 90, buff: ["attack"], description: "A bow of legendary power, said to be forged by the gods themselves." },
    "mythic_staff": { name: "Mythic Staff", type: "weapon", subtype: "staff", rarity: "mythic", value: 690, damage: 80, buff: ["magic"], description: "A staff of legendary power, said to be forged by the gods themselves." },
    // Mythic Armor
    "mythic_armor_set": { name: "Mythic Armor Set", type: "set", subtype: "armor", rarity: "mythic", value: 7550, items: ["mythic_helmet", "mythic_chestplate", "mythic_leggings", "mythic_boots", "mythic_gauntlets"], description: "An armor set of legendary power, said to be forged by the gods themselves." },
    "mythic_helmet": { name: "Mythic Helmet", type: "armor", slot: "head", subtype: "mythic", rarity: "mythic", value: 1500, defense: 50, buff: ["defense"], description: "A helmet of legendary power, said to be forged by the gods themselves." },
    "mythic_chestplate": { name: "Mythic Chestplate", type: "armor", slot: "torso", subtype: "mythic", rarity: "mythic", value: 1950, defense: 100, buff: ["defense"], description: "A chestplate of legendary power, said to be forged by the gods themselves." },
    "mythic_leggings": { name: "Mythic Leggings", type: "armor", slot: "legs", subtype: "mythic", rarity: "mythic", value: 1950, defense: 75, buff: ["defense"], description: "Leggings of legendary power, said to be forged by the gods themselves." },
    "mythic_boots": { name: "Mythic Boots", type: "armor", slot: "boots", subtype: "mythic", rarity: "mythic", value: 1500, defense: 50, buff: ["defense"], description: "Boots of legendary power, said to be forged by the gods themselves." },
    "mythic_gauntlets": { name: "Mythic Gauntlets", type: "armor", slot: "hands", subtype: "mythic", rarity: "mythic", value: 1500, defense: 50, buff: ["defense"], description: "Gauntlets of legendary power, said to be forged by the gods themselves." },
    "mythic_shield": { name: "Mythic Shield", type: "armor", slot: "shield", subtype: "mythic", rarity: "mythic", value: 1950, defense: 100, buff: ["defense"], description: "A shield of legendary power, said to be forged by the gods themselves." },

};

export const UNIQUE_ITEMS = {
    // Unique Weapons -- Standard, non-god-tier items that are unique in nature
    "sterling_sword": { name: "Sterling Sword", type: "weapon", subtype: "sword", rarity: "unique", value: 850, damage: 50, description: "A finely crafted sword with a unique design." },
    "obsidian_dagger": { name: "Obsidian Dagger", type: "weapon", subtype: "dagger", rarity: "unique", value: 690, damage: 40, description: "A dagger made from sharp obsidian, known for its cutting edge." },
    "enchanted_bow": { name: "Enchanted Bow", type: "weapon", subtype: "bow", rarity: "unique", value: 770, damage: 45, description: "A bow imbued with magical properties, enhancing its accuracy and power." },
    "mystic_staff": { name: "Mystic Staff", type: "weapon", subtype: "staff", rarity: "unique", value: 920, damage: 55, description: "A staff that channels mystical energies, increasing spell potency." },
    // Unique Weapons -- God-tier, mythic items that are unique in nature
    "excalibur": { name: "Excalibur", type: "weapon", subtype: "sword", rarity: "mythic", value: 1350, damage: 170, description: "The legendary sword of King Arthur, said to possess immense power." },
    "dagger_of_time": { name: "Dagger of Time", type: "weapon", subtype: "dagger", rarity: "mythic", value: 1500, damage: 190, description: "A dagger that can manipulate time, allowing the wielder to slow or speed up time." },
    "bow_of_eternity": { name: "Bow of Eternity", type: "weapon", subtype: "bow", rarity: "mythic", value: 1550, damage: 195, description: "A bow that never misses its target, said to be blessed by the gods." },
    "staff_of_wisdom": { name: "Staff of Wisdom", type: "weapon", subtype: "staff", rarity: "mythic", value: 1450, damage: 185, buff: ["magic"], description: "A staff that grants the wielder unparalleled knowledge and insight." },
    // Unique Armor -- Standard, non-god-tier items that are unique in nature
    "shadow_cloak": { name: "Shadow Cloak", type: "armor", slot: "cloak", subtype: "unique", rarity: "unique", value: 700, defense: 60, description: "A cloak that allows the wearer to blend into shadows, enhancing stealth." },
    "amulet_of_protection": { name: "Amulet of Protection", type: "armor", slot: "necklace", rarity: "unique", value: 480, defense: 40, buff: ["defense"], description: "An amulet that provides a protective aura, reducing damage taken." },
    // Unique Armor -- God-tier, mythic items that are unique in nature
    "aegis_shield": { name: "Aegis Shield", type: "armor", slot: "shield", rarity: "unique", value: 1100, defense: 100, buff: ["defense"], description: "The legendary shield of Zeus, said to be unbreakable and capable of deflecting any attack." },
    "helm_of_valor": { name: "Helm of Valor", type: "armor", slot: "head", rarity: "unique", value: 1000, defense: 90, buff: ["defense"], description: "A helmet that inspires courage and bravery in battle, said to be worn by legendary heroes." },
    "guilded_chestplate": { name: "Guilded Chestplate", type: "armor", slot: "torso", rarity: "unique", value: 950, defense: 85, buff: ["defense"], description: "A chestplate adorned with intricate guild symbols, offering both protection and prestige." },
    "kopeks_leggings": { name: "Kopeks Leggings", type: "armor", slot: "legs", rarity: "unique", value: 850, defense: 75, buff: ["defense"], description: "Leggings that provide unmatched agility and protection, said to be favored by elite warriors." },
    "boots_of_swiftness": { name: "Boots of Swiftness", type: "armor", slot: "boots", rarity: "unique", value: 800, defense: 70, buff: ["defense"], description: "Boots that grant the wearer incredible speed and agility, said to be favored by legendary warriors." },
    "cloak_of_invisibility": { name: "Cloak of Invisibility", type: "armor", slot: "cloak", rarity: "unique", value: 590, defense: 50, buff: ["defense"], description: "A cloak that renders the wearer invisible, said to be a gift from the gods themselves." },
    "ring_of_eternity": { name: "Ring of Eternity", type: "armor", slot: "ring", rarity: "unique", value: 400, defense: 30, buff: ["defense"], description: "A ring that grants the wearer immortality, said to be forged by the gods themselves." },
};
...
export const MINING_RESOURCES = {
    ...
    // Basic Resources
    "coal": { name: "Coal", type: "mining", subtype: "fuel", rarity: "common", value: 4 },
    "coal_chunks": { name: "Coal Chunks", type: "mining", subtype: "fuel", rarity: "common", value: 4 },
    "coal_dust": { name: "Coal Dust", type: "mining", subtype: "fuel", rarity: "common", value: 4 },
    "coal_ore": { name: "Coal Ore", type: "mining", subtype: "fuel", rarity: "common", value: 4 },
    "charcoal": { name: "Charcoal", type: "smithing", subtype: "fuel", rarity: "common", value: 4 },
    "flux": { name: "Flux", type: "smithing", subtype: "alloy", rarity: "uncommon", value: 50 },
    "limestone": { name: "Limestone", type: "smithing", subtype: "alloy", rarity: "uncommon", value: 50 },

    // Gemstones
    "ruby": { name: "Ruby", type: "mining", subtype: "gemstone", rarity: "rare", value: 140 },
    "sapphire": { name: "Sapphire", type: "mining", subtype: "gemstone", rarity: "rare", value: 140 },
    "emerald": { name: "Emerald", type: "mining", subtype: "gemstone", rarity: "rare", value: 140 },
    "diamond": { name: "Diamond", type: "mining", subtype: "gemstone", rarity: "legendary", value: 320 },
    "amethyst": { name: "Amethyst", type: "mining", subtype: "gemstone", rarity: "epic", value: 230 },
    "topaz": { name: "Topaz", type: "mining", subtype: "gemstone", rarity: "epic", value: 230 },
    "opal": { name: "Opal", type: "mining", subtype: "gemstone", rarity: "epic", value: 230 },
};
...
export const MAGIC_RESOURCES = {
    ...
    "ley_crystals": { name: "Ley Crystals", type: "crafting", subtype: "magic", rarity: "rare", value: 120 },
    "arcane_essence": { name: "Arcane Essence", type: "crafting", subtype: "magic", rarity: "legendary", value: 280 },
    "mystic_dust": { name: "Mystic Dust", type: "crafting", subtype: "magic", rarity: "epic", value: 200 },
    "void_shard": { name: "Void Shard", type: "crafting", subtype: "magic", rarity: "mythic", value: 520 },
    "celestial_fragment": { name: "Celestial Fragment", type: "crafting", subtype: "magic", rarity: "godlike", value: 800 },
    "enchanted_essence": { name: "Enchanted Essence", type: "crafting", subtype: "magic", rarity: "legendary", value: 280 },
    "mystic_essence": { name: "Mystic Essence", type: "crafting", subtype: "magic", rarity: "epic", value: 200 },
    "arcane_shard": { name: "Arcane Shard", type: "crafting", subtype: "magic", rarity: "rare", value: 120 },
    "void_essence": { name: "Void Essence", type: "crafting", subtype: "magic", rarity: "mythic", value: 520 },
    "celestial_shard": { name: "Celestial Shard", type: "crafting", subtype: "magic", rarity: "godlike", value: 800 },
    "enchanted_shard": { name: "Enchanted Shard", type: "crafting", subtype: "magic", rarity: "legendary", value: 280 },
    "mystic_shard": { name: "Mystic Shard", type: "crafting", subtype: "magic", rarity: "epic", value: 200 },
    "arcane_essence": { name: "Arcane Essence", type: "crafting", subtype: "magic", rarity: "rare", value: 120 },
    "void_fragment": { name: "Void Fragment", type: "crafting", subtype: "magic", rarity: "mythic", value: 520 },
    "celestial_essence": { name: "Celestial Essence", type: "crafting", subtype: "magic", rarity: "godlike", value: 800 },
    "enchanted_fragment": { name: "Enchanted Fragment", type: "crafting", subtype: "magic", rarity: "legendary", value: 280 },
    "mystic_fragment": { name: "Mystic Fragment", type: "crafting", subtype: "magic", rarity: "epic", value: 200 },
};
...
export const MAGIC_ITEMS = {
    ...
    "basic_scroll": { name: "Basic Scroll", type: "magic", subtype: "scroll", rarity: "common", value: 6 },
    "enchanted_scroll": { name: "Enchanted Scroll", type: "magic", subtype: "scroll", rarity: "uncommon", value: 30 },
    "ancient_scroll": { name: "Ancient Scroll", type: "magic", subtype: "scroll", rarity: "rare", value: 100 },
    "mystic_scroll": { name: "Mystic Scroll", type: "magic", subtype: "scroll", rarity: "epic", value: 180 },
    "arcane_scroll": { name: "Arcane Scroll", type: "magic", subtype: "scroll", rarity: "legendary", value: 250 },

    "simple_wand": { name: "Simple Wand", type: "magic", subtype: "wand", rarity: "common", value: 6 },
    "enchanted_wand": { name: "Enchanted Wand", type: "magic", subtype: "wand", rarity: "uncommon", value: 30 },
    "ancient_wand": { name: "Ancient Wand", type: "magic", subtype: "wand", rarity: "rare", value: 100 },
    "mystic_wand": { name: "Mystic Wand", type: "magic", subtype: "wand", rarity: "epic", value: 180 },
    "arcane_wand": { name: "Arcane Wand", type: "magic", subtype: "wand", rarity: "legendary", value: 250 },
    "crystal_wand": { name: "Crystal Wand", type: "magic", subtype: "wand", rarity: "mythic", value: 450 },
    "void_wand": { name: "Void Wand", type: "magic", subtype: "wand", rarity: "godlike", value: 700 },

    "basic_runestone": { name: "Basic Runestone", type: "magic", subtype: "rune", rarity: "common", value: 10 },
    "enchanted_runestone": { name: "Enchanted Runestone", type: "magic", subtype: "rune", rarity: "uncommon", value: 50 },
    "ancient_runestone": { name: "Ancient Runestone", type: "magic", subtype: "rune", rarity: "rare", value: 150 },
    "mystic_runestone": { name: "Mystic Runestone", type: "magic", subtype: "rune", rarity: "epic", value: 250 },
    "arcane_runestone": { name: "Arcane Runestone", type: "magic", subtype: "rune", rarity: "legendary", value: 350 },

    "simple_talisman": { name: "Simple Talisman", type: "magic", subtype: "talisman", rarity: "common", value: 11 },
    "enchanted_talisman": { name: "Enchanted Talisman", type: "magic", subtype: "talisman", rarity: "uncommon", value: 55 },
    "ancient_talisman": { name: "Ancient Talisman", type: "magic", subtype: "talisman", rarity: "rare", value: 170 },
    "mystic_talisman": { name: "Mystic Talisman", type: "magic", subtype: "talisman", rarity: "epic", value: 280 },
    "arcane_talisman": { name: "Arcane Talisman", type: "magic", subtype: "talisman", rarity: "legendary", value: 390 },

    "crystal_orb": { name: "Crystal Orb", type: "magic", subtype: "focus", rarity: "legendary", value: 520 },
    "dim_crystal": { name: "Dim Crystal", type: "magic", subtype: "crystal", rarity: "uncommon", value: 45 },
    "glowing_crystal": { name: "Glowing Crystal", type: "magic", subtype: "crystal", rarity: "rare", value: 130 },
    "red_crystal": { name: "Red Crystal", type: "magic", subtype: "crystal", rarity: "rare", value: 130 },
    "blue_crystal": { name: "Blue Crystal", type: "magic", subtype: "crystal", rarity: "rare", value: 130 },
    "green_crystal": { name: "Green Crystal", type: "magic", subtype: "crystal", rarity: "rare", value: 130 },
    "white_crystal": { name: "White Crystal", type: "magic", subtype: "crystal", rarity: "legendary", value: 300 },
    "void_crystal": { name: "Void Crystal", type: "magic", subtype: "crystal", rarity: "mythic", value: 550 },
    "black_crystal": { name: "Black Crystal", type: "magic", subtype: "crystal", rarity: "godlike", value: 850 },

    "glowing_orb": { name: "Glowing Orb", type: "magic", subtype: "orb", rarity: "rare", value: 180 },
    "red_orb": { name: "Red Orb", type: "magic", subtype: "orb", rarity: "rare", value: 180 },
    "blue_orb": { name: "Blue Orb", type: "magic", subtype: "orb", rarity: "rare", value: 180 },
    "green_orb": { name: "Green Orb", type: "magic", subtype: "orb", rarity: "epic", value: 310 },
    "black_orb": { name: "Black Orb", type: "magic", subtype: "orb", rarity: "legendary", value: 430 },
    "white_orb": { name: "White Orb", type: "magic", subtype: "orb", rarity: "mythic", value: 800 },
    "void_orb": { name: "Void Orb", type: "magic", subtype: "orb", rarity: "godlike", value: 1250 },

    "simple_spellbook": { name: "Simple Spellbook", type: "magic", subtype: "book", rarity: "common", value: 14 },
    "enchanted_spellbook": { name: "Enchanted Spellbook", type: "magic", subtype: "book", rarity: "uncommon", value: 70 },
    "ancient_spellbook": { name: "Ancient Spellbook", type: "magic", subtype: "book", rarity: "rare", value: 210 },
    "mystic_spellbook": { name: "Mystic Spellbook", type: "magic", subtype: "book", rarity: "epic", value: 350 },
    "arcane_spellbook": { name: "Arcane Spellbook", type: "magic", subtype: "book", rarity: "legendary", value: 490 },
    "crystal_spellbook": { name: "Crystal Spellbook", type: "magic", subtype: "book", rarity: "legendary", value: 490 },
    "mythic_spellbook": { name: "Mythic Spellbook", type: "magic", subtype: "book", rarity: "mythic", value: 910 },
    "demonic_spellbook": { name: "Demonic Spellbook", type: "magic", subtype: "book", rarity: "godlike", value: 1400 },

    "simple_void": { name: "Simple Void", type: "magic", subtype: "focus", rarity: "common", value: 15 },
    "dim_void": { name: "Dim Void", type: "magic", subtype: "focus", rarity: "common", value: 15 },
    "humming_void": { name: "Humming Void", type: "magic", subtype: "focus", rarity: "uncommon", value: 75 },
    "enchanted_void": { name: "Enchanted Void", type: "magic", subtype: "focus", rarity: "uncommon", value: 75 },
    "glowing_void": { name: "Glowing Void", type: "magic", subtype: "focus", rarity: "rare", value: 220 },
    "red_void": { name: "Red Void", type: "magic", subtype: "focus", rarity: "rare", value: 220 },
    "blue_void": { name: "Blue Void", type: "magic", subtype: "focus", rarity: "rare", value: 220 },
    "green_void": { name: "Green Void", type: "magic", subtype: "focus", rarity: "epic", value: 370 },
    "crystal_void": { name: "Crystal Void", type: "magic", subtype: "focus", rarity: "legendary", value: 520 },
    "white_void": { name: "White Void", type: "magic", subtype: "focus", rarity: "legendary", value: 520 },
    "mythic_void": { name: "Mythic Void", type: "magic", subtype: "focus", rarity: "mythic", value: 960 },
    "demonic_void": { name: "Demonic Void", type: "magic", subtype: "focus", rarity: "mythic", value: 960 },
