...
export const LOCATIONS = {
  ...
  town_square: {
    ...
    exits: [
      ...
      { label: "market square", to: "market_square", category: "path" },
  ...
  market_square: {
    ...
    region: "haven",
    name: "market square",
    description: "The Market Square - a bustling area filled with various shops.",
    flavorText: [
      "The market square is alive with activity, merchants calling out their wares.",
      "",
      timeLine,
      "",
      weatherLine,
      "",
      dangerLine,
      "People bustle about, some haggling over prices, others simply browsing.",
      firstVisitLine,
      "",
      healthLine,
      packLine,
    ...
    safe: true,
    exits: [
      { label: "town square", to: "town_square", category: "path" },
      { label: "food market", to: "food_market", category: "shop" },
      { label: "blacksmith", to: "blacksmith", category: "shop" },
      { label: "potions", to: "potions_shop", category: "shop" },
      { label: "general store", to: "general_store", category: "shop" },
      { label: "magic shop", to: "magic_shop", category: "shop" },
  ...
  cave_hub: {
    ...
    flavorText: [
      ...
      "",
      firstVisitLine,
      "The seams down here run to runite ore, if you've brought a pick that can bite it.",
      "The walls are lined with veins of ore, and the air is thick with dust.",
      "",
      dangerLine,
      healthLine,
...
// ** Town Square Shops
  blacksmith: {
    ...
    region: "haven",
    name: "blacksmith",
    description: "The Blacksmith - racks of blades and battered firearms line the walls.",
    flavorText: [
    ...
    safe: true,
    exits: [{ label: "market square", to: "market_square", category: "path" }],
    interactiveActions: [],
    hubFeatures: ["shop_weapons", "shop_armor", "shop_scrap", "shop_ammo", "shop_repair", "shop_sell"],
  ...
  food_market: {
    ...
    region: "haven",
    name: "food market",
    description: "The Food Market - stalls filled with fresh produce and baked goods.",
    flavorText: [
      "A hand-painted sign says FRESH and LOCAL, twice, in different pens.",
      indoorTimeLine,
      "",
      openLine,
      "The stalls are filled with fresh produce, baked goods, and other food items. You can find fruits, vegetables, bread, and pastries, all locally sourced.",
      "",
      packLine,
    ],
    safe: true,
    exits: [{ label: "market square", to: "market_square", category: "path" }],
    interactiveActions: [],
    hubFeatures: ["shop_food", "shop_sell"],
    openHours: { open: 8, close: 20 },
  }, 
  ...
  magic_shop: {
    ...
    flavorText: [
      "A hand-painted sign says NO EXCHANGES, twice, in different pens, and a faint glow seems to come from the shelves of strange artifacts and crystals.",
      indoorTimeLine,
      "",
      openLine,
      "The shelves are lined with strange artifacts and glowing crystals, most of them second-hand and none of them cheap. You can find scrolls, wands, and other magical items, all with labels written in a language you don't recognize.",
      "",
      packLine,
    ],
    safe: true,
    exits: [{ label: "market square", to: "market_square", category: "path" }],
    interactiveActions: [],
    hubFeatures: ["shop_magic", "shop_sell"],
    openHours: { open: 8, close: 20 },
  },
  ...
  general_store: {
    ...
    exits: [{ label: "market square", to: "market_square", category: "path" }],
    interactiveActions: [],
    hubFeatures: ["shop_general", "shop_food", "shop_crafting", "shop_sell"],
  },
